# AGENTS.md — Projekt-Kontext für Aviassembly

> Diese Datei wird von Codex automatisch als Kontext geladen. Sie fasst
> alles zusammen, damit eine andere Codex-Instanz (auf einem anderen Gerät)
