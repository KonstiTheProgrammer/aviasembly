...
# Die Ringe kommen als ECHTES Modell ins Spiel (nicht als prozeduraler Nachbau).
# Formbare Enden gehen trotzdem: PartCatalog._modell_enden_formen verbiegt die
# importierte Geometrie entlang ihrer Laengsachse. Der Shape "c130_tube" im Katalog
# ist nur noch der Notnagel, falls ein glb fehlt.
